...
public class MainControllerTest {
    ...
    public void mainPageTest() throws Exception{
        this.mockMvc.perform(get("/main"))
                ...
                .andExpect(xpath("//div[@id='navbarSupportedContent']/div").string("useronetest"));
    }
    @Test
    ...
    public void addMessageToListTest()throws Exception{
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=6]").exists())
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=5]/div/span").string("messageAdd"))
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=5]/div/i").string("newTest"));
    }
}
